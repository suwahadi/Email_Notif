...
<p><?php printf( __( 'Order dari %s %s telah dibatalkan. Info detail sebagai berikut:', WC_Subscriptions::$text_domain ), $order->billing_first_name, $order->billing_last_name ); ?></p>
