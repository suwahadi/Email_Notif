...
<?php if ($order->status=='pending') : ?>
	...
	<p><?php printf( __( 'Terima kasih telah membuat akun %s. Untuk melanjutkan pembayaran, silahkan gunakan link: %s', 'woocommerce' ), get_bloginfo( 'name' ), '<a href="' . $order->get_checkout_payment_url() . '">' . __( 'pay', 'woocommerce' ) . '</a>' ); ?></p>
